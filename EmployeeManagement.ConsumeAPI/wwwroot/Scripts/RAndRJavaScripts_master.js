...
var RAndRJavaScripts = {
    ...
    tools: {
        ...
        cancelGridEdit: function (divNames, kendoGrid) {
            ...
            if (typeof kendoGrid != 'undefined' && kendoGrid != null) {
                RAndRJavaScripts.grid.getSelectedUID[kendoGrid] = "";
            }
        },
        ...
        getDateFormated: function (value) {
            ...
            if (value == '' || value == null) {
                ...
                var dateText = dt.getFullYear() +
                    ...
                    "-" +
                    ("0" + dt.getDate()).slice(-2);
                return new Date(dateText).toString().replace(/\S+\s(\S+)\s(\d+)\s(\d+)\s.*/, '$2-$1-$3');;
            }
        },
    ...
    cgrid: {
        addDataToTheGridFromDiv: function (gridId, divId, primaryKeyTag) {
            ...
            var divData = RAndRJavaScripts.div.getJsonObjectFromDiv(divId, primaryKeyTag);
            if (divData.id != "") {
        ...
        editGridData: function (e, targetDiv, primaryKeyTag) {
            ...
            RAndRJavaScripts.div.loadDivControlFromJson(jObj, primaryKeyTag);
        },
        ...
        deleteGridData: function (e) {
            ...
            RAndRJavaScripts.cgrid.removeRow(grid, e.data.id);
        },
    ...
    grid: {
        ...
        selectedRow: {
            ...
            loadDataToDivControl: function (e, _this, primaryKeyTag) {
                ...
                RAndRJavaScripts.grid.getSelectedUID = {};
                RAndRJavaScripts.grid.getSelectedUID[_this.element[0].id] = dataItem.uid;
                ...
                RAndRJavaScripts.div.loadDivControlFromJson(jObj); //??
            },
    ...
    multi: {
        ...
        loadDataFromJson: function (multi, data) {
            ...
            RAndRJavaScripts.multi.multiObjs[multi] = mulVal;
        }
    },
        ...
        dropDown: function (id, textField, valueField, listWidth, _template, _valueTemplate, filter, urlpath, _selectedIndex, _optionLabel, _isApproval, _isFilter, func) {
            ...
            function kendoDataSourceWithFilter(filter, urlpath, fn) {
                ...
                if (this.dataSource._data.length == 0) {
                    RAndRJavaScripts.actionCall(urlpath, { 'IsApproval': _isApproval }, 'GET', function (data, result) {
                        // 
    ...
    CheckPositveNumber: function (key) {
        try {
            ...
            if (!/^(0?[1-9]\d*)$/.test(input)) {
                ...
                $('#e' + key).addClass('showError');
                $('#e' + key).removeClass('hideError');
                RAndRJavaScripts.message.showError('#showErrorMsg', 'Enter a positive number!', 10000);
                return;
            }
...
function OnKendoMultiSelectChange(e) {
    ...
    var previous = RAndRJavaScripts.multi.multiObjs[multuId];
    var diff = $(previous).not(current).get();
    RAndRJavaScripts.multi.delVals[multuId] = diff;
}
...
function OnKendoMultiSelectSelect(e) {
    ...
    RAndRJavaScripts.multi.addVals[multuId] = newItem;
}
